...
export class AppComponent {
  ...
  ttdata = {
    ...
    totals: [4, 16, null],
    rows: [
      { type: "Topic", name: "Chemistry / Organic / Amines", values: [1, 10, null], node: "q1" },
      { type: "Topic", name: "Mathematics / Calculus / Integration", values: [1, 10, null], node: "q2" },
      { type: "Topic", name: "Mathematics / Calculus / Differentiation", values: [1, 10, null], node: "q2" },
      { type: "Topic", name: "Chemistry / Organic / Alkanes", values: [1, 10, null], node: "q3" },
      { type: "Difficulty", name: "Easy", values: [1, 10, null], node: "q3" },
      { type: "Topic", name: "Chemistry / InOrganic / s-Block Elements", values: [1, 10, null], node: "q4" },
      { type: "Difficulty", name: "Medium", values: [1, 10, null], node: "q4" },
      { type: "Topic", name: "Mathematics / Vectors", values: [1, 10, null], node: "q5" },
      { type: "Difficulty", name: "Hard", values: [1, 10, null], node: "q5" },
    ],
  }
