...
fdescribe('Default Marker tests:', () => {
  ...
  it('mcq-arq-tfq-ncq works', () => {
    expect(() => marker.mcq([1], [2])).not.toThrow()
    expect(() => marker.tfq([1, 2], [2])).toThrow()
    expect(() => marker.arq([1], [2, 1])).toThrow()
    expect(() => marker.arq([], [])).toThrow()
  ...
  it('maq works', () => {
    expect(() => marker.maq([1], [2]).value).not.toThrow()
    expect(() => marker.maq([], [2]).value).toThrow()
    expect(() => marker.maq([1], [2, 3]).value).toThrow()
    expect(() => marker.maq([1, 1], [2]).value).toThrow()
    expect(() => marker.maq([1, 2], [2, 2]).value).toThrow()
...
fdescribe('NIOS Marker tests:', () => {
  let marker = new GeneralMarker()
  it('naq works', () => {
    expect(() => marker.naq([3], [3])).not.toThrow()
    expect(() => marker.naq([3], [6])).toThrow()
